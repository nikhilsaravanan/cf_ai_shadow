/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 49d82106673d223b20e68ce0ae113255)
// Runtime types generated with workerd@1.20260424.1 2026-04-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "WalletAgent" | "ResearcherAgent";
	}
	interface Env {
		ABI_CACHE: KVNamespace;
		ASSETS: Fetcher;
		CLOUDFLARE_ACCOUNT_ID: "52d2759780ed12447a3c603ff79693e3";
		SUPABASE_URL: "https://mxtsdphcrpyfrustzqbq.supabase.co";
		SHADOW_DEV: string;
		ALCHEMY_API_KEY: string;
		ETHERSCAN_API_KEY: string;
		WORKERS_AI_API_TOKEN: string;
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		ResearcherAgent: DurableObjectNamespace<import("./src/server").ResearcherAgent>;
		WalletAgent: DurableObjectNamespace<import("./src/server").WalletAgent>;
		IngestWorkflow: Workflow<Parameters<import("./src/server").IngestWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "SUPABASE_URL" | "SHADOW_DEV" | "ALCHEMY_API_KEY" | "ETHERSCAN_API_KEY" | "WORKERS_AI_API_TOKEN" | "GOOGLE_GENERATIVE_AI_API_KEY">> {}
}
